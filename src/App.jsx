    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',fontFamily:'system-ui,sans-serif',color:'#1e293b'}}>
                      ...
                      {(() => {
                        ...
                        return (
                          <tr style={{borderTop:'2px solid #1e293b',background:'#1e293b',color:'#fff'}}>
                            ...
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalProposed}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgProposalRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalContracts}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgContractRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalTossups}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgTossupRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalNgs}</td>
                          </tr>
                        );
                      })()}
                    </tbody>
                    ...
                    <tbody>
                      ...
                      {(() => {
                        ...
                        return (
                          <tr style={{borderTop:'2px solid #1e293b',background:'#1e293b',color:'#fff'}}>
                            <td style={{padding:'12px 8px',fontWeight:'700'}}>合計</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalVisits}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalProposed}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgProposalRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalContracts}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgContractRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalTossups}</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{avgTossupRate}%</td>
                            <td style={{padding:'12px 8px',textAlign:'center',fontWeight:'700'}}>{totalIds}</td>
      ...
      {detailModal && (
        <div style={{position:'fixed',top:0,left:0,right:0,bottom:0,background:'rgba(0,0,0,0.6)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1002,padding:'20px'}} onClick={()=>setDetailModal(null)}>
          <div style={{background:'#fff',borderRadius:'16px',maxWidth:'600px',width:'100%',maxHeight:'80vh',overflow:'hidden',boxShadow:'0 20px 60px rgba(0,0,0,0.3)'}} onClick={e=>e.stopPropagation()}>
