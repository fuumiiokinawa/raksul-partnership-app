...
export default function App() {
  ...
  function exportCSV() {
    const h = ['訪問日','担当者','企業名','業種','事務所','提案タイミング','ID状態','メールアドレス','バンク提案','ペイ提案','モール提案','MEO提案','動画提案','バンク結果','ペイ結果','モール結果','MEO結果','動画結果','バンクNG','ペイNG','モールNG','MEONG','動画NG','モール未購入理由','ID未開設理由','動画申込','報酬','備考'];
