...
const MEO_TOSSUP_URL = 'https://share.hsforms.com/1p6DfrcdGSI2g-nClt0KI_Arqgpr';
...
const PRODUCT_DETAILS = [
  ...
  { id: 'meo', name: 'MEO対策', tagline: 'Googleマップ上位表示', color: '#7C3AED', icon: '📍', docUrl: MEO_DOC_URL, tossupUrl: MEO_TOSSUP_URL, features: [{ label: 'セルフプラン', value: '1万円/月' },{ label: 'プロプラン', value: '4万円/月', highlight: true },{ label: '対策内容', value: '多数' },{ label: '他社比較', value: '安め', highlight: true }], target: '店舗ビジネス', salesPoint: '明確なニーズあり', incentive: '契約: ¥10,000' },
...
export default function App() {
  ...
  function exportCSV() {
    const h = ['訪問日','担当者','企業名','業種','事務所','提案タイミング','ID状態','バンク提案','ペイ提案','モール提案','MEO提案','動画提案','バンク結果','ペイ結果','モール結果','MEO結果','動画結果','バンクNG','ペイNG','モールNG','MEONG','動画NG','報酬','備考'];
    const rows = records.map(r => [r.visit_date,r.staff,r.company,r.industry,r.office,r.timing,r.raksul_id_status,r.proposal_bank,r.proposal_pay,r.proposal_mall,r.proposal_meo,r.proposal_video,r.result_bank,r.result_pay,r.result_mall,r.result_meo,r.result_video,r.ng_bank,r.ng_pay,r.ng_mall,r.ng_meo,r.ng_video,calcIncentive(r),r.note]);
                  ...
                  <table style={{width:'100%',borderCollapse:'collapse',fontSize:'13px',minWidth:'800px'}}>
                    <thead>
                      <tr style={{background:'#f8fafc'}}>
                        {['日付','担当','企業名','事務所','タイミング','ID','提案','結果','報酬','操作'].map(h=>
