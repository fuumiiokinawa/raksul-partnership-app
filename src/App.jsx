          ...
          <div style={{background:'#fff',borderRadius:'16px',width:'100%',maxWidth:'500px',maxHeight:'90vh',overflow:'auto'}} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{padding:'20px'}}>
              ...
              <div style={{marginTop:'12px',display:'grid',gap:'8px'}}>
                ...
                {selectedProduct.orderUrl&&<a href={selectedProduct.orderUrl} target="_blank" rel="noopener noreferrer" style={{display:'block',padding:'12px',background:'#7c3aed',color:'#fff',textAlign:'center',borderRadius:'8px',textDecoration:'none',fontWeight:'600',fontSize:'14px'}}>🎟️ クーポン付き注文（500円OFF）</a>}
          ...
          <div style={{background:'#fff',borderRadius:'16px',maxWidth:'380px',width:'100%',overflow:'hidden',boxShadow:'0 20px 60px rgba(0,0,0,0.3)'}}>
            ...
            <div style={{padding:'20px'}}>
              <div style={{textAlign:'center',marginBottom:'20px'}}>
                <div style={{fontSize:'15px',fontWeight:'600',color:'#1e293b',marginBottom:'8px'}}>「クーポン付き注文（500円OFF）」ボタンより</div>
              ...
              <div style={{display:'grid',gap:'10px'}}>
                ...
                <button 
                  onClick={()=>{setFormData({...formData,video_ordered:'未申込'});window.open(VIDEO_ORDER_URL,'_blank');setShowVideoOrderModal(false);}} 
