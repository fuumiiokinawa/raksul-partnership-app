...
const VIDEO_ORDER_URL = 'https://web-marketing.raksul.com/content/orders/new?coupon_code=JQW6R7WX';
...
const PRODUCT_DETAILS = [
  ...
  { id: 'video', name: '出張動画撮影', tagline: '5万円で撮影', color: '#DC2626', icon: '🎬', url: 'https://st.raksul.com/web-marketing/content', orderUrl: VIDEO_ORDER_URL, sheetUrl: VIDEO_SHEET_URL, features: [{ label: '撮影費用', value: '5万円', highlight: true },{ label: '納品', value: '写真+動画' },{ label: '用途', value: '多数' },{ label: '月額', value: '500円〜', highlight: true }], target: '素材がない企業', salesPoint: '写真ないですよね？', incentive: '契約: ¥10,000' },
  ...
  { 
    ...
    sections: [
      ...
      },
      {
        subtitle: '出張動画撮影',
        items: [
          '🎟️ クーポン付き注文リンク：お客様に共有（500円OFF適用）',
          ...
          <div>
            <div style={{background:'#fff',borderRadius:'12px',padding:'16px',marginBottom:'16px',border:'1px solid #e2e8f0'}}>
              ...
              <div style={{marginBottom:'16px'}}>
                ...
                <div style={{display:'flex',gap:'8px',flexWrap:'wrap'}}>
                  <a href={VIDEO_ORDER_URL} target="_blank" rel="noopener noreferrer" style={{padding:'8px 14px',borderRadius:'6px',background:'#dc2626',color:'#fff',fontSize:'12px',fontWeight:'600',textDecoration:'none'}}>🎟️ クーポン付き注文（500円OFF）</a>
          ...
          <div style={{background:'#fff',borderRadius:'16px',width:'100%',maxWidth:'500px',maxHeight:'90vh',overflow:'auto'}} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{padding:'20px'}}>
              ...
              <div style={{marginTop:'12px',display:'grid',gap:'8px'}}>
                ...
                {selectedProduct.orderUrl&&<a href={selectedProduct.orderUrl} target="_blank" rel="noopener noreferrer" style={{display:'block',padding:'12px',background:'#7c3aed',color:'#fff',textAlign:'center',borderRadius:'8px',textDecoration:'none',fontWeight:'600',fontSize:'14px'}}>🎟️ クーポン付き注文リンク（500円OFF）</a>}
