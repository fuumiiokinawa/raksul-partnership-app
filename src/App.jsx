          ...
          <div>
            <div style={{background:'#fff',borderRadius:'12px',padding:'16px',marginBottom:'16px',border:'1px solid #e2e8f0'}}>
              ...
              <div style={{display:'flex',gap:'10px',flexWrap:'wrap',marginBottom:'10px'}}>
                ...
                <a href={MEO_SCHEDULE_URL} target="_blank" rel="noopener noreferrer" style={{padding:'10px 16px',borderRadius:'8px',background:'#0ea5e9',color:'#fff',fontSize:'13px',fontWeight:'600',textDecoration:'none'}}>📅 商談スケジュール</a>
              </div>
